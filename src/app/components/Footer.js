...
import { faBackwardStep, faPlay, faPause, faVolumeHigh, faShuffle, faRepeat, faSliders, faBarsStaggered } from '@fortawesome/free-solid-svg-icons';

export default function Footer() {
    const [playMusic, setPlayMusic] = useState(false)
    return (
        <footer className=" absolute bottom-0 mt-auto w-full h-20 bg-gray-950 rounded-none md:rounded-b-xl flex flex-row items-center justify-between border-t md:border-none border-gray-800">
            <div className="mx-4 h-full w-full bg-yellow-5000 flex items-center justify-between gap-2">
                <div className="w-auto md:w-[205px] h-full flex items-center">
                    {playMusic ? (
                        <div className=" bg-gray-900 w-9 md:size-12 mr-3 rounded-full overflow-hidden animate-spin">
                        ...
                        <div className=" bg-gray-900 w-9 md:size-12 mr-3 rounded-full overflow-hidden">
                            <Image src="https://lh3.googleusercontent.com/pw/AP1GczPjrv_UWqeDNfCdewXBj8zq0W6i513KwGoVDNNnW2b8kj4RAG5YUfvzmRBpPz9hMEyFyPwWTuxDsWdg6RMIMYNHeENCmCso1M7ZcTp2TjFDU0_d_wf9GuUFiDKPggGkJIYSYAsGvP8LU8NQmeNA81kXrg=w617-h617-s-no-gm?authuser=0" 
                            width={400} 
                            height={41.188} 
                            alt="" />
                ...
                <div className="bg-blue-6000 w-2/5 flex flex-col justify-center px-1">
                    <div className="bg-red-7000 flex justify-center ">
                        <div className="bg-green-7000 w-28 sm:w-52 flex justify-around pb-1">
                            ...
                            {playMusic ? (
                                <button onClick={() => setPlayMusic(false)} className="group/de bg-blue-7000 size-6 sm:size-9 pr-1 relative outline-none rounded-full bg-red-600 hover:bg-red-700 hover:drop-shadow-md shadow-yellow-600 flex items-center justify-center text-[15px] sm:text-[22px] text-white">
                                    <FontAwesomeIcon icon={faPause} />
                                </button>
                            ):(
                                <button onClick={() => setPlayMusic(true)} className="group/de bg-blue-7000 size-6 sm:size-9 p-0 relative outline-none rounded-full bg-red-600 hover:bg-red-700 hover:drop-shadow-md shadow-yellow-600 flex items-center justify-center text-[15px] sm:text-[22px] text-white">
                ...
                <div className="inline-flex gap-0">
                    ...
                    <div className="w-auto h-auto flex flex-row items-center">
                        ...
                        min="0"
                        max="100" 
                        className="w-6 md:w-16 sm:w-10 h-1 mx-1 cursor-pointer" 
                        />
                    </div>
                    <button className="bg-transparent size-6 sm:size-9 p-0 relative outline-none rounded-full hover:bg-red-700 hover:drop-shadow-md shadow-yellow-600 flex items-center justify-center  text-[15px] sm:text-[22px] text-white">
